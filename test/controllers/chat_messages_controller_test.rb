...
class ChatMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chat_message" do
    assert_difference('ChatMessage.count') do
      post chat_messages_url, params: { chat_message: { chat_room_id: @chat_message.chat_room_id, message: @chat_message.message } }
    end
  ...
  test "should update chat_message" do
    patch chat_message_url(@chat_message), params: { chat_message: { chat_room_id: @chat_message.chat_room_id, message: @chat_message.message } }
