class ChatRoomsController < ApplicationController
  ...
  def index
    ...
    # @chat_rooms = @user.chat_rooms_as_sender + @user.chat_rooms_as_reciever
  end
  ...
  private
    ...
    def chat_room_params
      params.require(:chat_room).permit(:senderable_id, :senderable_type, :recieverable_id, :recieverable_type)
    end
end
